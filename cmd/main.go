...
import (
	...
	"github.com/ppurva1711-creator/cloudos-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "82ed545a.cloudos.io",
	...
	if err := (&controller.TaskJobReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "TaskJob")
		os.Exit(1)
	}
